...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button group/menu-button flex w-full items-center gap-2 overflow-hidden rounded-[calc(var(--radius-sm)+4px)] px-2 py-1.5 text-left text-xs ring-sidebar-ring outline-hidden transition-[width,height,padding] group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:bg-black/5 hover:text-sidebar-accent-foreground dark:hover:bg-white/5 focus-visible:ring-2 active:bg-black/5 active:text-sidebar-accent-foreground dark:active:bg-white/5 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-black/5 data-open:hover:text-sidebar-accent-foreground dark:data-open:hover:bg-white/5 data-active:bg-black/5 data-active:font-medium data-active:text-sidebar-accent-foreground dark:data-active:bg-white/5 [&_svg]:size-4 [&_svg]:shrink-0 [&>span:last-child]:truncate",
  {
    variants: {
      variant: {
        default: "hover:bg-black/5 hover:text-sidebar-accent-foreground dark:hover:bg-white/5",
        outline:
          "bg-background shadow-[0_0_0_1px_hsl(var(--sidebar-border))] hover:bg-black/5 hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_hsl(var(--sidebar-accent))] dark:hover:bg-white/5",
      },
      size: {
        default: "h-7 text-xs",
        sm: "h-6 text-xs",
...
function SidebarMenuSubButton({
  ...
  return useRender({
    ...
    props: mergeProps<"a">(
      {
        className: cn(
          "flex h-6 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-[calc(var(--radius-sm)+3px)] px-2 text-sidebar-foreground ring-sidebar-ring outline-hidden group-data-[collapsible=icon]:hidden hover:bg-black/5 hover:text-sidebar-accent-foreground dark:hover:bg-white/5 focus-visible:ring-2 active:bg-black/5 active:text-sidebar-accent-foreground dark:active:bg-white/5 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[size=md]:text-xs data-[size=sm]:text-xs data-active:bg-black/5 data-active:text-sidebar-accent-foreground dark:data-active:bg-white/5 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
          className
        ),
      },
      props
