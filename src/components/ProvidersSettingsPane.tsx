...
function sortProviders(providers: ProviderSummary[]) {
...
function getProviderButtonLabel(provider: ProviderSummary) {
...
function createUrlParameterValues(urlParameters: ProviderUrlParam[]) {
  ...
  useEffect(() => {
    ...
    async function loadProviders() {
      ...
      try {
        ...
        setProviders([]);
        setProvidersError(normalizeError(error));
      } finally {
        if (!isCancelled) {
