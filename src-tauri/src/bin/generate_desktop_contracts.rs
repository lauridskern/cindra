...
use agent_ui_lib::dto::{
    ...
    FollowupKind, FollowupOptionDto, FollowupRequestDto, FollowupResponseDto, GitWorkspaceKindDto,
    HandoffChatInput, OutputPreviewDto, PromptModelOptionDto, PromptSettingsDto,
    ...
    UpdatePromptSettingsInput, UpdateSavedWorkspaceLayoutInput, WorkspaceKindDto,
    WorkspaceSessionDto,
};
use anyhow::Context;
use ts_rs::{Config, TS};
