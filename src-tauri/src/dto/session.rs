...
pub fn session_messages_from_conversation(conversation: &Conversation) -> Vec<SessionMessageDto> {
...
pub fn derive_conversation_title_from_messages(messages: &[SessionMessageDto]) -> String {
